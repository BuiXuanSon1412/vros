...
def read_data(path):  # read_data_smith_small_data
    ...
    manhattan_move_matrix = [[0.0] * number_of_cities for _ in range(number_of_cities)]

    euclid_flight_matrix = [[0.0] * number_of_cities for _ in range(number_of_cities)]

    value_tan_of_city = [0.0] * number_of_cities
    city = []
    ...
    for i in range(number_of_cities):
        for j in range(number_of_cities):
            manhattan_move_matrix[i][j] = (
                manhattan_distance(city[i], city[j]) / truck_speed
            )
...
def read_data2(path):  # read dataSmith <=20
    ...
    value_tan_of_city = [] * number_of_cities
    city = []
